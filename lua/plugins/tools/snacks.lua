...
return {
  {
    ...
    keys = {
      ...
      },
      {
        ...
        desc = '[S]earch [p]roject (enhanced fuzzy)',
      },
      {
        '<leader>sP',
        function()
        ...
        desc = '[S]earch [P]roject (standard)',
      },
      {
        '<leader>pp',
        function()
