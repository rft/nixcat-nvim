    ...
    keys = {
      {
        ...
        function()
          ...
          local listed = vim.tbl_filter(function(b)
            return vim.api.nvim_buf_is_valid(b) and vim.bo[b].buflisted and vim.api.nvim_buf_is_loaded(b)
    ...
    keys = {
      {
        ...
        desc = 'Move buffer to right window',
      },
      {
        '<leader>bh',
        function()
        ...
        desc = 'Move buffer to left window',
      },
      {
        '<leader>bj',
        function()
        ...
        desc = 'Move buffer to lower window',
      },
      {
        '<leader>bk',
        function()
        ...
        desc = 'Move buffer to upper window',
      },
    },
  },
}
